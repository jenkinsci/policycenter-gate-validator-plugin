...
public class PolicyCenterGateCheckBuilder extends Builder {
    ...
    public PolicyCenterGateCheckBuilder(String project, String gate) {
    ...
    public boolean perform(AbstractBuild<?, ?> build, Launcher launcher, BuildListener listener) throws InterruptedException {
    	CheckGateBuilderDescriptor descriptor = getDescriptor();
...
//        	}
    ...
    @Override
    public CheckGateBuilderDescriptor getDescriptor() {
        return (CheckGateBuilderDescriptor)super.getDescriptor();
    }

    @Extension
    public static final class CheckGateBuilderDescriptor extends BuildStepDescriptor<Builder> {
        ...
        private static final Logger _LOGGER = Logger.getLogger(CheckGateBuilderDescriptor.class.getName());
		...
		public CheckGateBuilderDescriptor() {
            load();
        }
